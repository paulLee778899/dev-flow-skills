...
- Use an independent checker subagent for final requirements/design/test coverage and readiness judgments; the main agent may collect evidence but must not be the only reviewer for pass/fail.
