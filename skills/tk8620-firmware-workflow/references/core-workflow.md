...
- [Burn Protocol Boundary](#burn-protocol-boundary)
- [Bootloader Decision](#bootloader-decision)
- [Generic Build Flow](#generic-build-flow)
- [Artifact Trust Gate](#artifact-trust-gate)
- [Generic Burn And Serial Flow](#generic-burn-and-serial-flow)
- [Automatic Burn And Smoke Test](#automatic-burn-and-smoke-test)
