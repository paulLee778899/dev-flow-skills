...
- Any scoring, sufficiency review, gate pass/fail, or readiness decision must use at least 2 independent checker subagents that review raw artifacts and produce findings before the main agent revises. Persist scores/count; gate passage requires all checker scores ≥ 95 unless the user explicitly accepts a documented risk.
