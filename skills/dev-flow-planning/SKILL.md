...
- Any scoring, sufficiency review, gate pass/fail, or readiness decision must use a checker subagent that reviews raw artifacts and produces findings before the main agent revises. Persist the checker score; gate passage requires checker score ≥ 95 unless the user explicitly accepts a documented risk.
